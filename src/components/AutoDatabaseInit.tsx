...
VALUES 
  ('UNINASSAU Graças', 'Universidade', 'R. Joaquim Nabuco, 1469 - Graças, Recife/PE', '(81) 3333-4444')
ON CONFLICT DO NOTHING;

-- Inserir estações baseadas nas instituições
INSERT INTO estacoes_7af4432d (instituicao_id, nome, endereco, latitude, longitude, horario_funcionamento, status)
SELECT 
  i.id,
  'Estação - ' || i.nome,
  i.endereco,
