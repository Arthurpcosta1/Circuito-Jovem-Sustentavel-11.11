...
export function StationsMap() {
  ...
  const stations: Station[] = [
    ...
    {
      id: '2',
      name: 'UNINASSAU Graças - Bloco B',
      address: 'R. Joaquim Nabuco, 1469 - Graças, Recife',
      hours: '07:00 - 22:00',
      ambassador: 'Rafael Santos',
      distance: '0.15 km',
      status: 'open',
      coordinates: { lat: -8.0388, lng: -34.9042 }
    },
    {
      id: '3',
      name: 'UNINASSAU Graças - Bloco C',
      address: 'R. Joaquim Nabuco, 1469 - Graças, Recife',
      hours: '07:00 - 22:00',
      ambassador: 'João Gabriel',
      distance: '0.2 km',
      status: 'busy',
      coordinates: { lat: -8.0390, lng: -34.9036 }
    },
    {
      id: '4',
      name: 'UNINASSAU Graças - Bloco D',
      address: 'R. Joaquim Nabuco, 1469 - Graças, Recife',
      hours: '07:00 - 22:00',
      ambassador: 'Mariana Silva',
      distance: '0.25 km',
      status: 'open',
      coordinates: { lat: -8.0382, lng: -34.9045 }
    },
    {
      id: '5',
      name: 'UNINASSAU Graças - Bloco E',
      address: 'R. Joaquim Nabuco, 1469 - Graças, Recife',
      hours: '07:00 - 22:00',
      ambassador: 'Pedro Costa',
      distance: '0.3 km',
      status: 'open',
      coordinates: { lat: -8.0393, lng: -34.9040 }
    }
  ];
